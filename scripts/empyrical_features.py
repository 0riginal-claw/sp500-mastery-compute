"""quantopian/empyrical feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/empyrical"
)
...
def add_empyrical_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add empyrical features.
    ...
    try:
        ...
        LOG.warning("add_empyrical_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
