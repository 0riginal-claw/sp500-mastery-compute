"""quantopian/alphalens feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/alphalens"
)
...
def add_alphalens_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add alphalens features.
    ...
    try:
        ...
        LOG.warning("add_alphalens_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
