"""ranaroussi/quantstats feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/quantstats"
)
...
def add_quantstats_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add quantstats features.
    ...
    try:
        ...
        LOG.warning("add_quantstats_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
