"""bradleyboyuyang/Statistical-Arbitrage feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/Statistical-Arbitrage"
)
...
def add_statistical_arbitrage_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add Statistical-Arbitrage features.
    ...
    try:
        ...
        LOG.warning("add_statistical_arbitrage_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
