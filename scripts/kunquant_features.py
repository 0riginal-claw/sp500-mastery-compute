"""Menooker/KunQuant feature wrapper.

Source: https://github.com/Menooker/KunQuant
License: Apache-2.0
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/KunQuant"
)
...
def add_kunquant_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add KunQuant features.
    ...
    try:
        ...
        LOG.warning("add_kunquant_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
