"""Tommel71/Event-Study-Statistics feature wrapper.

Source: https://github.com/Tommel71/Event-Study-Statistics
License: Apache-2.0
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/Event-Study-Statistics"
)
...
def add_event_study_statistics_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add Event-Study-Statistics features.
    ...
    try:
        ...
        LOG.warning("add_event_study_statistics_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
