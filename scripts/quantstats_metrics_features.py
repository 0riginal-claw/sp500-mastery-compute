"""quantstats_metrics feature module (template-generated)

Auto-generated by feature_wiring_consumer_daemon fast-path (template tier).
Feature: quantstats_metrics
Data source: github:ranaroussi/quantstats
Generated: 2026-05-18T04:19:52.021992+00:00
...
def compute_quantstats_metrics_features(df: pd.DataFrame,
                                          ticker: Optional[str] = None) -> pd.DataFrame:
    """Append quantstats_metrics feature columns to df.
