"""ranaroussi/yfinance feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/yfinance"
)
...
def add_yfinance_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add yfinance features.
    ...
    try:
        ...
        LOG.warning("add_yfinance_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
