"""lcsrodriguez/ecocal feature wrapper.

Source: https://github.com/lcsrodriguez/ecocal
License: MIT
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/ecocal"
)
...
def add_ecocal_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add ecocal features.
    ...
    try:
        ...
        LOG.warning("add_ecocal_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
