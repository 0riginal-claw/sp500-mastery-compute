"""haynieresearch/unusual_options_activity feature wrapper.

Source: https://github.com/haynieresearch/unusual_options_activity
License: Apache-2.0
Discovered: 2026-05-17 (longtail_03)
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/unusual_options_activity"
)
...
def add_unusual_options_activity_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add unusual_options_activity features.
    ...
    try:
        ...
        LOG.warning("add_unusual_options_activity_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
