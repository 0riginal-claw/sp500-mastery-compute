"""skyte/momentum feature wrapper.

Source: https://github.com/skyte/momentum
License: Apache-2.0
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/momentum"
)
...
def add_momentum_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    ...
    try:
        ...
        LOG.warning("add_momentum_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
