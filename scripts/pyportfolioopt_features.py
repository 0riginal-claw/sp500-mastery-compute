"""PyPortfolio/PyPortfolioOpt feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/PyPortfolioOpt"
)
...
def add_pyportfolioopt_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add PyPortfolioOpt features.
    ...
    try:
        ...
        LOG.warning("add_pyportfolioopt_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
