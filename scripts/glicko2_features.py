"""sublee/glicko2 feature wrapper.

Source: https://github.com/sublee/glicko2
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/glicko2"
)
...
def add_glicko2_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add glicko2 features.
    ...
    try:
        ...
        LOG.warning("add_glicko2_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
