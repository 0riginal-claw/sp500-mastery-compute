"""skfolio/skfolio feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/skfolio"
)
...
def add_skfolio_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add skfolio features.
    ...
    try:
        ...
        LOG.warning("add_skfolio_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
