"""tradermonty/market-breadth-analysis feature wrapper.

Source: https://github.com/tradermonty/market-breadth-analysis
License: MIT
Discovered: 2026-05-17 (longtail_06)
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/market-breadth-analysis"
)
...
def add_market_breadth_analysis_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add market-breadth-analysis features.
    ...
    try:
        ...
        LOG.warning("add_market_breadth_analysis_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
