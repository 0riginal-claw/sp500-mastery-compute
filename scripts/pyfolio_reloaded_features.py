"""stefan-jansen/pyfolio-reloaded feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/pyfolio-reloaded"
)
...
def add_pyfolio_reloaded_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add pyfolio-reloaded features.
    ...
    try:
        ...
        LOG.warning("add_pyfolio_reloaded_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
