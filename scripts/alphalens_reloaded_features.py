"""stefan-jansen/alphalens-reloaded feature wrapper.
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/alphalens-reloaded"
)
...
def add_alphalens_reloaded_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add alphalens-reloaded features.
    ...
    try:
        ...
        LOG.warning("add_alphalens_reloaded_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
