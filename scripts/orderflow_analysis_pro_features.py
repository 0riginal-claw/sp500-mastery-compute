"""mahmoud20138/OrderFlow-Analysis-Pro feature wrapper.

Source: https://github.com/mahmoud20138/OrderFlow-Analysis-Pro
License: MIT
Discovered: 2026-05-17 (longtail_04)
...
_CLONE_ROOT = Path(
    ...
    "My Drive/AI-Tools/repos-claude-clones/OrderFlow-Analysis-Pro"
)
...
def add_orderflow_analysis_pro_features(df: pd.DataFrame, ticker: str) -> pd.DataFrame:
    """Add OrderFlow-Analysis-Pro features.
    ...
    try:
        ...
        LOG.warning("add_orderflow_analysis_pro_features failed for %s: %s", ticker, e)
        return _zero_fill(df)
